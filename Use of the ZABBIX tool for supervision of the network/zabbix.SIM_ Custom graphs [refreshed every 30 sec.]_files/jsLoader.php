...
locale['S_MAX_COOKIE_SIZE_REACHED'] = 'We are sorry, the maximum possible number of elements to remember has been reached.';locale['S_EXPAND'] = 'Expand';locale['S_COLLAPSE'] = 'Collapse';locale['Cancel'] = 'Cancel';locale['Execute'] = 'Execute';locale['Execution confirmation'] = 'Execution confirmation';locale['Acknowledge'] = 'Acknowledge';locale['Access denied'] = 'Access denied';locale['Cancel'] = 'Cancel';locale['Configuration'] = 'Configuration';locale['Create trigger'] = 'Create trigger';locale['Dashboard sharing'] = 'Dashboard sharing';locale['Delete service "%1$s"?'] = 'Delete service \"%1$s\"?';locale['Do you wish to replace the conditional expression?'] = 'Do you wish to replace the conditional expression?';locale['Edit trigger'] = 'Edit trigger';locale['Insert expression'] = 'Insert expression';locale['Trigger status "OK"'] = 'Trigger status \"OK\"';locale['Trigger status "Problem"'] = 'Trigger status \"Problem\"';locale['Item "%1$s"'] = 'Item \"%1$s\"';locale['Go to'] = 'Go to';locale['Graphs'] = 'Graphs';locale['History'] = 'History';locale['Host inventory'] = 'Host inventory';locale['Host screens'] = 'Host screens';locale['Latest data'] = 'Latest data';locale['Latest values'] = 'Latest values';locale['Last hour graph'] = 'Last hour graph';locale['Last month graph'] = 'Last month graph';locale['Last week graph'] = 'Last week graph';locale['Problems'] = 'Problems';locale['Refresh interval'] = 'Refresh interval';locale['Refresh interval multiplier'] = 'Refresh interval multiplier';locale['Scripts'] = 'Scripts';locale['Something went wrong. Please try again later!'] = 'Something went wrong. Please try again later!';locale['Submap'] = 'Submap';locale['Trigger'] = 'Trigger';locale['Triggers'] = 'Triggers';locale['Update'] = 'Update';locale['URL'] = 'URL';locale['URLs'] = 'URLs';locale['No refresh'] = 'No refresh';locale['You need permission to perform this action!'] = 'You need permission to perform this action!';locale['10 seconds'] = '10 seconds';locale['30 seconds'] = '30 seconds';locale['1 minute'] = '1 minute';locale['2 minutes'] = '2 minutes';locale['10 minutes'] = '10 minutes';locale['15 minutes'] = '15 minutes';locale['S_MUTE'] = 'Mute';locale['S_UNMUTE'] = 'Unmute';locale['S_MESSAGES'] = 'Messages';locale['S_CLEAR'] = 'Clear';locale['S_SNOOZE'] = 'Snooze';/*  Prototype JavaScript framework, version 1.6.1
...
var _json_stringify = JSON.stringify;JSON.stringify = function(value) {var _array_tojson = Array.prototype.toJSON,ret;delete Array.prototype.toJSON;ret = _json_stringify(value);Array.prototype.toJSON = _array_tojson;return ret;};